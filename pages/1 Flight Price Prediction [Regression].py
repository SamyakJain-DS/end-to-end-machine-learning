...
data = pd.read_csv('E:/Machine Learning Project/Flight Price Prediction/cleaned_flights.csv')
with open('E:/Machine Learning Project/Flight Price Prediction/flight_model.pkl', 'rb') as f:
    model = pickle.load(f)
with open('E:/Machine Learning Project/Flight Price Prediction/flight_pipeline.pkl', 'rb') as f:
    x_pipeline = pickle.load(f)
with open('E:/Machine Learning Project/Flight Price Prediction/flight_y_pipeline.pkl', 'rb') as f:
